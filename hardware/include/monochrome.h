 ...
 * 1-bit binary monochrome value AXIS packet. */
 ...
 * thresholding on the grayscale value. This is the combinational interface to
 * the module.
 *
 ...
 * value. This is the sequential interface to the module.
 *
